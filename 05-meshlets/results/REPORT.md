# Rapport de banc — 05-meshlets

> **`Partitionnement en clusters de 64/128/256/512 triangles`**
...
- `05-meshlets/types.ts` — contrats de type (squelette, aucun algorithme)
- `05-meshlets/benchmark.md` — cahier des charges (paliers, métriques obligatoires, règle d'arbitrage)
- `05-meshlets/implementation.md` — plan d'implémentation (non livré)
- `05-meshlets/results/latest.json` — squelette `not-run` (champs `null` conformément au schéma)
