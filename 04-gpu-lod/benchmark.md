...
Les données brutes sont automatiquement écrites dans [`results/latest.json`](results/latest.json) selon la structure contractuelle définie dans [`MASTER_TEST_PLAN.md`](../MASTER_TEST_PLAN.md).
