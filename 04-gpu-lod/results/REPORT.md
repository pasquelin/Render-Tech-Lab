...
**Dernière mise à jour :** 11/09/2026 20:28:22  
...
1. **04A — Génération LOD (`meshoptimizer`) :**
   - La décimation hors thread UI produit une réduction géométrique massive (**75.0% de triangles économisés**) en **5.7 ms** sans saccade de frame.
...
- **Temps total de décimation (Worker) :** `5.7 ms`
