...
```json
{
  ...
  "sources": {
    "before": {
      "timestamp": "2026-09-11T21:31:30.921Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
    ...
    "after": {
      "timestamp": "2026-09-11T21:31:39.960Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Référence 04B | 180 | 0.800 | 1.500 | 2.100 | 8.300 | 9.300 | 5.274 |
| Tangente partagée | 180 | 0.600 | 1.600 | 2.300 | 8.300 | 9.200 | 4.451 |
| Tangente partagée | 180 | 0.500 | 1.400 | 2.300 | 8.300 | 9.300 | 4.675 |
| Référence 04B | 180 | 0.800 | 1.600 | 2.800 | 8.300 | 9.000 | 5.475 |
...
```json
{
  ...
  "preparationMs": {
    "sceneAndCompileMs": 76.59999999403954,
    "trajectoryControlsMs": 205.30000001192093,
    "pixelQualityMs": 648.5
  }
}
```
