...
```json
{
  ...
  "preparation": {
    "sceneMs": 11.300000011920929,
    "initialControlsMs": 486.5999999642372,
    "finalControlMs": 114.40000003576279
  }
}
```
...
|---|---:|---:|---:|---:|---:|---:|---|---|
| 1 · B WGSL | 240 | non mesuré | 0.162 | 0.208 | 0.753 | 120.00 | 8.300 / 9.000 / 9.200 | 0.00 % / 0.00 % / 0.00 % |
| 2 · A CPU | 240 | 0.157 | 0.130 | 0.328 | 0.558 | 120.04 | 8.300 / 9.300 / 9.400 | 0.00 % / 0.00 % / 0.00 % |
| 3 · A CPU | 240 | 0.151 | 0.135 | 0.326 | 0.462 | 120.00 | 8.300 / 9.300 / 9.400 | 0.00 % / 0.00 % / 0.00 % |
| 4 · B WGSL | 240 | non mesuré | 0.154 | 0.181 | 0.733 | 119.95 | 8.300 / 9.200 / 9.300 | 0.00 % / 0.00 % / 0.00 % |
