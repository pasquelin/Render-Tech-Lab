...
```json
{
  ...
  "sources": {
    "before": {
      "timestamp": "2026-09-11T21:27:57.452Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
    ...
    "after": {
      "timestamp": "2026-09-11T21:28:05.966Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Référence 04B | 180 | 0.100 | 0.300 | 0.500 | 8.300 | 8.900 | 1.547 |
| Tangente partagée | 180 | 0.000 | 0.200 | 0.400 | 8.300 | 9.000 | 1.587 |
| Tangente partagée | 180 | 0.000 | 0.300 | 0.700 | 8.300 | 8.700 | 1.256 |
| Référence 04B | 180 | 0.100 | 0.300 | 0.500 | 8.300 | 9.200 | 1.544 |
...
```json
{
  ...
  "preparationMs": {
    "sceneAndCompileMs": 23.5,
    "trajectoryControlsMs": 43.30000001192093,
    "pixelQualityMs": 376.59999999403954
  }
}
```
