...
```json
{
  ...
  "sources": {
    "before": {
      "timestamp": "2026-09-11T21:28:06.019Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
    ...
    "after": {
      "timestamp": "2026-09-11T21:28:14.630Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Référence 04B | 180 | 0.100 | 0.300 | 0.500 | 8.300 | 9.000 | 1.691 |
| Tangente partagée | 180 | 0.000 | 0.300 | 0.500 | 8.300 | 9.100 | 1.918 |
| Tangente partagée | 180 | 0.000 | 0.300 | 0.800 | 8.300 | 8.900 | 1.440 |
| Référence 04B | 180 | 0.100 | 0.300 | 0.500 | 8.300 | 9.000 | 1.966 |
...
```json
{
  ...
  "preparationMs": {
    "sceneAndCompileMs": 115.19999998807907,
    "trajectoryControlsMs": 42.80000001192093,
    "pixelQualityMs": 382
  }
}
```
