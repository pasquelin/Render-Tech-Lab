...
```json
{
  ...
  "sources": {
    "before": {
      "timestamp": "2026-09-11T21:30:55.524Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
    ...
    "after": {
      "timestamp": "2026-09-11T21:31:04.321Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Référence 04B | 180 | 0.700 | 1.400 | 2.400 | 8.300 | 9.000 | 5.176 |
| Tangente partagée | 180 | 0.400 | 1.500 | 2.600 | 8.300 | 9.300 | 5.112 |
| Tangente partagée | 180 | 0.400 | 1.400 | 2.500 | 8.300 | 9.200 | 4.798 |
| Référence 04B | 180 | 0.700 | 1.400 | 2.100 | 8.300 | 9.300 | 5.223 |
...
```json
{
  ...
  "preparationMs": {
    "sceneAndCompileMs": 82,
    "trajectoryControlsMs": 207.40000000596046,
    "pixelQualityMs": 416.2999999821186
  }
}
```
