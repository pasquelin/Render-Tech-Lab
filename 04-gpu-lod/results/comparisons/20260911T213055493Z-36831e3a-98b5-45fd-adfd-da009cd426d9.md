...
```json
{
  ...
  "sources": {
    "before": {
      "timestamp": "2026-09-11T21:30:46.781Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
    ...
    "after": {
      "timestamp": "2026-09-11T21:30:55.478Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Référence 04B | 180 | 0.800 | 1.600 | 2.200 | 8.300 | 9.300 | 5.089 |
| Tangente partagée | 180 | 0.400 | 1.400 | 2.700 | 8.300 | 9.300 | 5.065 |
| Tangente partagée | 180 | 0.400 | 1.300 | 2.300 | 8.300 | 9.200 | 5.270 |
| Référence 04B | 180 | 0.900 | 1.800 | 2.300 | 8.300 | 8.900 | 5.097 |
...
```json
{
  ...
  "preparationMs": {
    "sceneAndCompileMs": 91.59999999403954,
    "trajectoryControlsMs": 222.40000000596046,
    "pixelQualityMs": 316
  }
}
```
