...
```json
{
  ...
  "sources": {
    "before": {
      "timestamp": "2026-09-11T21:28:14.687Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
    ...
    "after": {
      "timestamp": "2026-09-11T21:28:23.589Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
...
|---|---:|---:|---:|---:|---:|---:|---:|
| Référence 04B | 180 | 0.100 | 0.200 | 0.300 | 8.300 | 9.200 | 2.401 |
| Tangente partagée | 180 | 0.100 | 0.300 | 0.600 | 8.300 | 9.300 | 2.702 |
| Tangente partagée | 180 | 0.000 | 0.200 | 0.300 | 8.300 | 9.200 | 2.679 |
| Référence 04B | 180 | 0.100 | 0.200 | 0.300 | 8.300 | 8.900 | 2.872 |
...
```json
{
  ...
  "preparationMs": {
    "sceneAndCompileMs": 13.199999988079071,
    "trajectoryControlsMs": 44,
    "pixelQualityMs": 778
  }
}
```
