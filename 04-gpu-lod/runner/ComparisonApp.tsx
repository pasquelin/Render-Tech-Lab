...
export function ComparisonApp() {
  ...
  return (
    <main className="h-full overflow-auto p-4 md:p-6 space-y-4">
      ...
      <form id="comparison-form" className="card bg-base-200 border border-base-content/10 p-4 gap-3">
        <fieldset id="comparison-controls" className="grid grid-cols-2 lg:grid-cols-6 gap-3">
          ...
          <Field id="shadows" label="Ombres">
            <input id="shadows" type="checkbox" className="checkbox checkbox-primary" defaultChecked />
          </Field>
        </fieldset>
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="text-xs text-base-content/70">Contrôles d&apos;image et de détail avant mesure · ordre A/B/B/A · 60 images d&apos;échauffement par bloc</span>
        </div>
        <p id="comparison-status" role="status" aria-live="polite" className="text-sm">Prêt. Aucune optimisation validée automatiquement.</p>
      </form>
