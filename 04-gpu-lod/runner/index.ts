...
import { generateLodsAsync } from '../implementation/lodWorker.ts';
import { selectLodsOnCpu } from '../implementation/cpuLodSelector.ts';
import {
  calculateProjectedGeometricError,
  isGeometricErrorAcceptable,
  CONTRACTUAL_MAX_ERROR_PX,
} from '../../shared/math/screenSpaceError.ts';
import type { LodBenchmarkSummary } from '../contracts.ts';
import { LOD_OBJECT_COUNTS } from '../contracts.ts';
