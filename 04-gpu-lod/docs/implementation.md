...
## 2. 04A — Web Worker de Décimation (`implementation/lodWorker.ts`)
...
## 3. 04B — Sélecteur Screen-Space Error CPU (`implementation/cpuLodSelector.ts`)
...
## 4. 04C — Compute Shader WGSL (`implementation/gpuLodShader.ts`)
