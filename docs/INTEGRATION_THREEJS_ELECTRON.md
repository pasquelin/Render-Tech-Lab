# Intégration Three.js et Electron
...
Un prototype bas niveau WebGPU isolé dans le laboratoire peut prouver un algorithme sans encore constituer un plugin Three.js intégré. Les deux validations sont nécessaires : calcul correct d'abord, composition correcte ensuite.
