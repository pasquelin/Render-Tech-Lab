# Les calculs qui font fonctionner le système
...
Lectures liées : [préparation des meshes](PREPARATION_DES_MESHES.md), [rendu et sélection](RENDU_ET_SELECTION.md), [contrats et recettes](CONTRATS_DONNEES_ET_TESTS.md), [oracle exécutable](ORACLES_ET_TESTS.md).
