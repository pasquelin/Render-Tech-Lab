# R&D Protocol: 01-indirect-draw (GPU-Driven Architecture)
...
- **Source files:**
  - `01-indirect-draw/baseline/` (Test A)
  - `01-indirect-draw/implementation/` (Test B)
  - `01-indirect-draw/benchmark/` (runner & metrics)
