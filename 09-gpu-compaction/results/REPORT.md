...
|:---:|:---:|:---:|:---:|:---:|
| **1,000** | `one-thread-per-command` | 0.04 ms | 500 | 0 |
| **1,000** | `atomicAdd` | 0.037 ms | 500 | 3,000 |
| **1,000** | `parallel-prefix-scan` | 0.141 ms | 500 | 0 |
| **10,000** | `one-thread-per-command` | 0.349 ms | 5,000 | 0 |
| **10,000** | `atomicAdd` | 0.345 ms | 5,000 | 30,000 |
| **10,000** | `parallel-prefix-scan` | 1.158 ms | 5,000 | 0 |
| **100,000** | `one-thread-per-command` | 0.464 ms | 50,000 | 0 |
| **100,000** | `atomicAdd` | 0.286 ms | 50,000 | 300,000 |
| **100,000** | `parallel-prefix-scan` | 4.35 ms | 50,000 | 0 |
| **1,000,000** | `one-thread-per-command` | 6.433 ms | 500,000 | 0 |
| **1,000,000** | `atomicAdd` | 3.066 ms | 500,000 | 3,000,000 |
| **1,000,000** | `parallel-prefix-scan` | 42.112 ms | 500,000 | 0 |
