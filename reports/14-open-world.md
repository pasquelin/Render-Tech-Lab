...
```json
{
  ...
  "preparationMs": 21712.40000000596,
  "qualityMs": 1934.9000000059605
}
```

## Mesures par bloc

Les lignes suivent l'ordre réel BAAB. Les répétitions nouvelles alternent ABBA et BAAB pour contrôler l’effet d’ordre. Durées en millisecondes ; p50 médiane, p95 et p99 pour les images les plus lentes. L'intervalle rAF est une cadence de callbacks, pas une mesure de présentation physique.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Culling adaptatif · visibilité certifiée | 240 | 84.300 | 94.900 | 103.700 | 34.746 | 240/240 | 83.400 | 97.000 | 107.500 | 17060218–28031231 | 25463034 |
| Culling Three.js | 240 | 88.200 | 106.400 | 108.800 | 39.258 | 240/240 | 91.700 | 108.300 | 112.600 | 17060218–28031231 | 25463034 |
| Culling Three.js | 240 | 88.800 | 104.800 | 107.600 | 38.776 | 240/240 | 91.200 | 108.400 | 109.400 | 17060218–28031231 | 25463034 |
| Culling adaptatif · visibilité certifiée | 240 | 89.000 | 106.200 | 110.000 | 38.909 | 240/240 | 91.600 | 108.400 | 112.700 | 17060218–28031231 | 25463034 |
...
|---|---:|---:|---:|---:|
| Culling adaptatif · visibilité certifiée | 11.71 | 239/240 | 100.00 % (239/239) | 100.00 % (239/239) |
| Culling Three.js | 10.99 | 239/240 | 100.00 % (239/239) | 100.00 % (239/239) |
| Culling Three.js | 11.01 | 239/240 | 100.00 % (239/239) | 100.00 % (239/239) |
| Culling adaptatif · visibilité certifiée | 10.97 | 239/240 | 100.00 % (239/239) | 100.00 % (239/239) |
...
```json
{
  ...
  "captures": [
    {
      "index": 0,
      "baselineHash": "c9c0ee9569895fee60b00e3e7eea52ad8b52a81e1310b2ec54125277f4d0e9d9",
      "repeatHash": "c9c0ee9569895fee60b00e3e7eea52ad8b52a81e1310b2ec54125277f4d0e9d9",
      "candidateHash": "c9c0ee9569895fee60b00e3e7eea52ad8b52a81e1310b2ec54125277f4d0e9d9",
    ...
    {
      "index": 119,
      "baselineHash": "a54fa75a991a68fecc442e540cd07e2a2d982331ecbfa7e1c4b7e23ee05fa6b7",
      "repeatHash": "a54fa75a991a68fecc442e540cd07e2a2d982331ecbfa7e1c4b7e23ee05fa6b7",
      "candidateHash": "a54fa75a991a68fecc442e540cd07e2a2d982331ecbfa7e1c4b7e23ee05fa6b7",
      "repeatDifferentBytes": 0,
      "candidateDifferentBytes": 0,
      "maxChannelDifference": 0,
      "candidateShadowPassTriangles": 25463034,
...
```json
{
  "environment": {
    ...
    "renderPixelRatio": 1,
    "performanceTimeOrigin": 1789168116317.8,
  ...
  "provenance": {
    "before": {
      "timestamp": "2026-09-11T23:11:19.976Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
      ...
      "sourceHashes": {
        ...
        "14-open-world/worldScene.ts": "10feac139b432b2eb6e76722b3bb45a064734713edf2a0a358acbc9f2a683fbb",
        "14-open-world/worldTypes.ts": "ff62db323d3756de5d28020ca12b73fc021ce64ef5f318dd8a4648f96cda6126",
        "14-open-world/worldPage.ts": "847be650cdc7736651f814b792dd7df08afcb253c9e199218804d4eeb4ec1972",
        ...
        "14-open-world/worldReporter.ts": "666e7380493638b5151cce06ff564c01f94db24095c208132668c7f48d75f215",
    ...
    "after": {
      "timestamp": "2026-09-11T23:13:54.727Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
...
- Common reference preparation traverses the full camera path for 120 frames before quality captures; its cost is included in preparationMs. Per-block warmup remains separate.
