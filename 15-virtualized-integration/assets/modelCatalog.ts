...
export const benchmarkModels: readonly BenchmarkModel[] = [
  { id: 'emerald-square', label: 'Emerald Square', sourceDirectory: 'public/benchmark-assets/emerald-square', derivedDirectory: 'public/benchmark-assets/emerald-square-derived', runtimeFile: 'emerald-day.gltf' },
