...
Dans la scène ouverte, la colonne de droite propose Orbite, Libre à pied et Jeu à la première personne ainsi que la ville de départ. La navigation et les collisions simplifiées sont propres à l’exploration du Lab ; voir [l’état actuel](docs/current.md) pour les commandes et leurs limites.
