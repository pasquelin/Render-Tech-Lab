...
export function moduleDescription(moduleId: string): string {
  ...
  if (moduleId === '15-virtualized-integration') return 'Fixture procédurale validée : comparaison A/B, clusters hiérarchiques, sélection WebGPU, dessin indirect, pages, cache et évictions. Emerald Square est accessible en exploration libre ; la comparaison complète reste bloquée par le contrôle A/A.';
