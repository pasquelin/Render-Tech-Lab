...
export function moduleDescription(moduleId: string): string {
  ...
  if (moduleId === '14-open-world') {
    return 'Rendu Three.js WebGL2 résident : une scène Bistro répétée en quartiers mesure la pression de rendu et de culling, avec la géométrie déjà chargée en mémoire. Ce banc ne met pas en œuvre de géométrie virtualisée.';
  }
