...
import { labCardClass } from './ui/LabSection.tsx';
import { Button } from './ui/Button.tsx';

/** Execution information belongs to the sidebar; the scene remains unobstructed. */
export function CampaignSidebar() {
  ...
  const nativeStop = state.moduleId === '04-gpu-lod' || state.moduleId === '14-open-world';
  return (
    <section data-campaign-sidebar={execution.status} className={`${labCardClass} min-w-0 space-y-3 break-words [overflow-wrap:anywhere]`}>
