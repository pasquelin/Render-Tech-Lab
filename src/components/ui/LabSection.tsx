...
export const labCardClass = 'card bg-base-300/80 border border-base-content/10 shadow-xs p-3.5 gap-2.5';
  ...
  return (
    <section id={id} className={labCardClass}>
      <header className="flex items-center justify-between gap-2">
        <h2 className="text-[11px] font-bold uppercase tracking-wider text-base-content/60">{number}. {title}</h2>
