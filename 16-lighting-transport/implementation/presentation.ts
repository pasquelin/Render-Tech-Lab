...
export const LIGHTING_MODULE: ModuleDescriptor = {
  ...
  technicalPrinciple: 'Le banc appelle prepare() et createExplorer() sans implémenter de rendu ni d’éclairage ; il détecte addLight/setLight/removeLight/setEnvironment/setTransform avant de les utiliser. Le moteur et le déplacement se choisissent comme au banc 15.',
