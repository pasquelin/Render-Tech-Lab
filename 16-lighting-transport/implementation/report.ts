...
export function formatLightingReport(report:LightingReport):string{
  ...
  return [
    ...
    '', 'Le rapport JSON contient les échantillons bruts, les captures PNG, les empreintes des sources, le matériel et les révisions des deux dépôts. Les copies des sources restent dans l’archive locale indiquée par provenance.sourceArchive.',
  ].join('\n');
}
