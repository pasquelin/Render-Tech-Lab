...
export {
  ...
  AUTO_LIGHT_MIN, AUTO_LIGHT_MAX, CAPABILITY_LABELS, LIGHTING_VIEWS, DEFAULT_LIGHTING_VIEW,
  DEFAULT_LIGHTING_BOUNCE, BOUNCE_DIAGNOSTIC, bounceUnavailable,
  SUN_LIGHT_ID, SUN_LIMITS, DEFAULT_SUN, sunDirection, sunLights,
  defaultAdjustableLights, defaultConfig, emptyLightingStats,
} from './contracts.ts';
