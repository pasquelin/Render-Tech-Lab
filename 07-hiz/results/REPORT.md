# Rapport de banc — 07-hiz

> **`Pyramide de profondeur Hi-Z (mip 0 → N)`**
...
- `07-hiz/types.ts` — contrats de type (squelette, aucun algorithme)
- `07-hiz/benchmark.md` — cahier des charges (paliers, métriques obligatoires, règle d'arbitrage)
- `07-hiz/implementation.md` — plan d'implémentation (non livré)
- `07-hiz/results/latest.json` — squelette `not-run` (champs `null` conformément au schéma)
