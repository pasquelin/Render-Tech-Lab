# Rapport de banc — 13-full-gpu-driven

> **`Pipeline GPU-driven unifié (03 → 13)`**
...
- `13-full-gpu-driven/types.ts` — contrats de type (squelette, aucun algorithme)
- `13-full-gpu-driven/benchmark.md` — cahier des charges (paliers, métriques obligatoires, règle d'arbitrage)
- `13-full-gpu-driven/implementation.md` — plan d'implémentation (non livré)
- `13-full-gpu-driven/results/latest.json` — squelette `not-run` (champs `null` conformément au schéma)
