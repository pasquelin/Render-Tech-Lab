...
## Description
Architecture de géométrie virtualisée basée sur le partitionnement en meshlets, culling par cluster sur GPU et sélection continue du niveau de détail (LOD).
