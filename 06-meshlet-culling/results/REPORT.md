# Rapport de banc — 06-meshlet-culling

> **`Culling frustum / cône / sub-pixel par meshlet`**
...
- `06-meshlet-culling/types.ts` — contrats de type (squelette, aucun algorithme)
- `06-meshlet-culling/benchmark.md` — cahier des charges (paliers, métriques obligatoires, règle d'arbitrage)
- `06-meshlet-culling/implementation.md` — plan d'implémentation (non livré)
- `06-meshlet-culling/results/latest.json` — squelette `not-run` (champs `null` conformément au schéma)
