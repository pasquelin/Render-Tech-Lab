...
```json
{
  ...
  "preparationMs": 3651.2000000178814,
  "qualityMs": 4087.9000000059605
}
```
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Culling Three.js | 120 | 7.800 | 9.200 | 9.700 | 4.917 | 120/120 | 16.600 | 16.800 | 16.900 | 2433894–3114583 | 2829226 |
| Ombres statiques réutilisées | 120 | 6.500 | 7.900 | 7.900 | 4.658 | 120/120 | 8.400 | 16.700 | 16.800 | 2433894–3114583 | 0 |
| Ombres statiques réutilisées | 120 | 6.700 | 8.000 | 8.200 | 4.575 | 120/120 | 8.400 | 17.100 | 17.600 | 2433894–3114583 | 0 |
| Culling Three.js | 120 | 8.200 | 9.700 | 10.300 | 4.816 | 120/120 | 16.400 | 17.400 | 17.600 | 2433894–3114583 | 2829226 |
...
|---|---:|---:|---:|---:|
| Culling Three.js | 73.61 | 119/120 | 0.00 % (0/119) | 0.00 % (0/119) |
| Ombres statiques réutilisées | 88.15 | 119/120 | 0.00 % (0/119) | 0.00 % (0/119) |
| Ombres statiques réutilisées | 86.55 | 119/120 | 0.00 % (0/119) | 0.00 % (0/119) |
| Culling Three.js | 72.13 | 119/120 | 0.00 % (0/119) | 0.00 % (0/119) |
...
```json
{
  ...
  "captures": [
    {
      "index": 0,
      "baselineHash": "fe8161d85512e998402f11ef44f044dfcbc20d2b2a6ce6482076d24c83d789f9",
      "repeatHash": "fe8161d85512e998402f11ef44f044dfcbc20d2b2a6ce6482076d24c83d789f9",
      "candidateHash": "fe8161d85512e998402f11ef44f044dfcbc20d2b2a6ce6482076d24c83d789f9",
    ...
    {
      "index": 59,
      "baselineHash": "27e94fd8c6e1960bca74c801a664045523c584a22242118eca1d27d85d4ba83d",
      "repeatHash": "27e94fd8c6e1960bca74c801a664045523c584a22242118eca1d27d85d4ba83d",
      "candidateHash": "27e94fd8c6e1960bca74c801a664045523c584a22242118eca1d27d85d4ba83d",
      "repeatDifferentBytes": 0,
      "candidateDifferentBytes": 0,
      "maxChannelDifference": 0,
      "candidateShadowPassTriangles": 0,
    ...
    {
      "index": 119,
      "baselineHash": "d0be75297dbd6481ebcd0955e36c233f7eeed9a5b0d800acdcbb5dfdb8a99da7",
      "repeatHash": "d0be75297dbd6481ebcd0955e36c233f7eeed9a5b0d800acdcbb5dfdb8a99da7",
      "candidateHash": "d0be75297dbd6481ebcd0955e36c233f7eeed9a5b0d800acdcbb5dfdb8a99da7",
      "repeatDifferentBytes": 0,
      "candidateDifferentBytes": 0,
      "maxChannelDifference": 0,
      "candidateShadowPassTriangles": 0,
...
```json
{
  "environment": {
    ...
    "renderPixelRatio": 1,
    "performanceTimeOrigin": 1789166223419.2,
  ...
  "provenance": {
    "before": {
      "timestamp": "2026-09-11T22:37:18.489Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
      ...
      "sourceHashes": {
        ...
        "14-open-world/worldPage.ts": "062dd9004905aff8e40bb78c7b7510660f8573157f28632edbefbb65fa2370dc",
    ...
    "after": {
      "timestamp": "2026-09-11T22:37:35.481Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
