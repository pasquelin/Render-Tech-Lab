...
```json
{
  ...
  "preparationMs": 4380.699999988079,
  "qualityMs": 5187.5
}
```
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Culling Three.js | 240 | 64.600 | 73.400 | 75.800 | 13.664 | 240/240 | 66.700 | 75.100 | 75.500 | 17060218–28031231 | 25463034 |
| Ombres et matrices statiques réutilisées | 240 | 61.700 | 77.900 | 80.700 | 27.734 | 240/240 | 66.600 | 83.300 | 83.400 | 17060218–28031231 | 0 |
| Ombres et matrices statiques réutilisées | 240 | 61.600 | 77.800 | 80.800 | 27.805 | 240/240 | 66.600 | 83.300 | 83.400 | 17060218–28031231 | 0 |
| Culling Three.js | 240 | 86.400 | 103.000 | 105.100 | 38.272 | 240/240 | 91.600 | 108.300 | 108.400 | 17060218–28031231 | 25463034 |
...
|---|---:|---:|---:|---:|
| Culling Three.js | 15.27 | 239/240 | 100.00 % (239/239) | 96.65 % (231/239) |
| Ombres et matrices statiques réutilisées | 15.67 | 239/240 | 100.00 % (239/239) | 84.94 % (203/239) |
| Ombres et matrices statiques réutilisées | 15.67 | 239/240 | 100.00 % (239/239) | 83.68 % (200/239) |
| Culling Three.js | 11.27 | 239/240 | 100.00 % (239/239) | 100.00 % (239/239) |
...
```json
{
  ...
  "captures": [
    {
      "index": 0,
      "baselineHash": "fa718be8e6cf9266c3a2edc390d96198801c37a838c81b8ddcbd59dc64bc6e8a",
      "repeatHash": "fa718be8e6cf9266c3a2edc390d96198801c37a838c81b8ddcbd59dc64bc6e8a",
      "candidateHash": "fa718be8e6cf9266c3a2edc390d96198801c37a838c81b8ddcbd59dc64bc6e8a",
...
```json
{
  ...
  "provenance": {
    "before": {
      "timestamp": "2026-09-11T22:44:45.232Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
    ...
    "after": {
      "timestamp": "2026-09-11T22:46:38.478Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
