...
```json
{
  ...
  "preparationMs": 11843.09999999404,
  "qualityMs": 2012.800000011921
}
```
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Culling Three.js | 120 | 69.900 | 80.100 | 81.600 | 14.031 | 120/120 | 74.900 | 83.300 | 83.400 | 17137185–28031231 | 25463034 |
| Culling adaptatif · dernier plan rejetant | 120 | 89.400 | 106.400 | 108.500 | 41.783 | 120/120 | 91.700 | 108.400 | 110.200 | 17137185–28031231 | 25463034 |
| Culling adaptatif · dernier plan rejetant | 120 | 92.800 | 108.900 | 112.000 | 43.580 | 120/120 | 95.500 | 108.800 | 113.400 | 17137185–28031231 | 25463034 |
| Culling Three.js | 120 | 90.600 | 108.700 | 112.200 | 43.093 | 120/120 | 92.100 | 108.500 | 116.200 | 17137185–28031231 | 25463034 |
...
|---|---:|---:|---:|---:|
| Culling Three.js | 13.99 | 119/120 | 100.00 % (119/119) | 100.00 % (119/119) |
| Culling adaptatif · dernier plan rejetant | 10.90 | 119/120 | 100.00 % (119/119) | 100.00 % (119/119) |
| Culling adaptatif · dernier plan rejetant | 10.62 | 119/120 | 100.00 % (119/119) | 100.00 % (119/119) |
| Culling Three.js | 10.73 | 119/120 | 100.00 % (119/119) | 100.00 % (119/119) |
...
```json
{
  ...
  "captures": [
    {
      "index": 0,
      "baselineHash": "490cd5d25aa3f16edcedb9d46c940e053d49db03f7986fa11467c0cd4509ce1b",
      "repeatHash": "490cd5d25aa3f16edcedb9d46c940e053d49db03f7986fa11467c0cd4509ce1b",
      "candidateHash": "490cd5d25aa3f16edcedb9d46c940e053d49db03f7986fa11467c0cd4509ce1b",
    ...
    {
      "index": 59,
      "baselineHash": "4fcf4ab98648b38e7c1275e8bb8599cee3d794baebf25a24402e6e76d74712dc",
      "repeatHash": "4fcf4ab98648b38e7c1275e8bb8599cee3d794baebf25a24402e6e76d74712dc",
      "candidateHash": "4fcf4ab98648b38e7c1275e8bb8599cee3d794baebf25a24402e6e76d74712dc",
      "repeatDifferentBytes": 0,
      "candidateDifferentBytes": 0,
      "maxChannelDifference": 0,
      "candidateShadowPassTriangles": 25463034,
    ...
    {
      "index": 119,
      "baselineHash": "918ce9279be8960437b02b663ec2321ef30f4674f4393b3dc6694cf6f6408dcd",
      "repeatHash": "918ce9279be8960437b02b663ec2321ef30f4674f4393b3dc6694cf6f6408dcd",
      "candidateHash": "918ce9279be8960437b02b663ec2321ef30f4674f4393b3dc6694cf6f6408dcd",
      "repeatDifferentBytes": 0,
      "candidateDifferentBytes": 0,
      "maxChannelDifference": 0,
      "candidateShadowPassTriangles": 25463034,
...
```json
{
  "environment": {
    ...
    "cssWidth": 1484,
    "cssHeight": 987,
    "rendererLogicalWidth": 3840,
    "rendererLogicalHeight": 2160,
    ...
    "renderPixelRatio": 1,
    "performanceTimeOrigin": 1789167727389.7,
  ...
  "provenance": {
    "before": {
      "timestamp": "2026-09-11T23:02:33.303Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
      ...
      "sourceHashes": {
        ...
        "14-open-world/worldScene.ts": "f3fd70aa8fc388295ac696bce801f38fbdf686afca64ee8bbac82d0a384e6fab",
        "14-open-world/worldTypes.ts": "a934980ad47d3998cd1e9b378d3358a2fcde7349d9fe5da1e70dff2b4ac7f283",
        "14-open-world/worldPage.ts": "baf68b629e125b654ecd4516503da2f38aa87f4fe6aafd82b75cd59f25f95c49",
    ...
    "after": {
      "timestamp": "2026-09-11T23:03:50.557Z",
      "node": "v26.8.2",
      "os": {
        "platform": "darwin",
        "release": "25.6.0",
...
- Common reference preparation traverses the full camera path for 60 frames before quality captures; its cost is included in preparationMs. Per-block warmup remains separate.
